...
class DemoElementState():
    ...
    def demo_explicit_wait(self):
        ...
        #implementing fluent wait here - 2s is the poll frequency (how often element is checked), ignore exception only difference between explicit wait and fluent wait is polling frequency and ignored exception
